            ...
            if len(feedDict.entries) == 0:
                ...
                if latestMsg[lnk]['title']:
                    ...
                    for i in range(sendMax):
                        ...
                        if not hakuBlock.has_block_word(newMsg): feedMsg.append(f'{feedDict.entries[i].title}\n{feedDict.entries[i].link}')
                    ...
                    if timeNow - time.mktime(feedDict.entries[0].updated_parsed) + time.altzone <= 300:
                        ...
                        if not hakuBlock.has_block_word(newMsg): feedMsg.append(f'{feedDict.entries[0].title}\n{feedDict.entries[0].link}')
                    # print(feedMsg)
